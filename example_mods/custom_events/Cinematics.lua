...
function onUpdate()
	...
	doTweenAlpha('AlphaTween9', 'ratingIcon', 0, 0.25)
	doTweenAlpha('AlphaTween10', 'missesIcon', 0, 0.25)
	doTweenAlpha('AlphaTween11', 'scoreIcon', 0, 0.25)
	doTweenAlpha('AlphaTween12', 'rating', 0, 0.25)
	doTweenAlpha('AlphaTween13', 'misses', 0, 0.25)
	doTweenAlpha('AlphaTween14', 'score', 0, 0.25)
	doTweenAlpha('AlphaTween15', 'song', 0, 0.25)
	doTweenAlpha('AlphaTween16', 'timer', 0, 0.25)
	doTweenAlpha('AlphaTween17', 'songIcon', 0, 0.25)
	doTweenAlpha('AlphaTween18', 'timerIcon', 0, 0.25)
	...
	doTweenAlpha('AlphaTween9', 'ratingIcon', 1, 0.25)
	doTweenAlpha('AlphaTween10', 'missesIcon', 1, 0.25)
	doTweenAlpha('AlphaTween11', 'scoreIcon', 1, 0.25)
	doTweenAlpha('AlphaTween12', 'rating', 1, 0.25)
	doTweenAlpha('AlphaTween13', 'misses', 1, 0.25)
	doTweenAlpha('AlphaTween14', 'score', 1, 0.25)
	doTweenAlpha('AlphaTween15', 'song', 1, 0.25)
	doTweenAlpha('AlphaTween16', 'timer', 1, 0.25)
	doTweenAlpha('AlphaTween17', 'songIcon', 1, 0.25)
	doTweenAlpha('AlphaTween18', 'timerIcon', 1, 0.25)
