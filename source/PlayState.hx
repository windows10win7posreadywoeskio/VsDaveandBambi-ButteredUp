...
class PlayState extends MusicBeatState
{
	...
	public static var watermarkes:FlxText;
	public static var creditmark:FlxText;
	public static var BPText:Array<String> = [
		'skill issue', // 0
		'quit fnf', //1
		'loser', //2
		'how do you not beat this song',//3
		'ratio',//4
		'remind me to disable 7',//5
		'remind me to disable botplay',//6
		'mmmmmmmmmm toasted butter',//7
		'you remind me of joehuh02',//8
		'you remind me of trash fnf player',//9
		'why do you use botplay',//10
		'this is why you get no bitches',//11
		'yo mama so dumb she had to embarass you when you got to school',//12
		'BOTPLAY',//13
		'wtf',//14
		'if you managed to get this far, then: dave and bambi rule34. it\'s horrible. i\'d say. bambi_69',//15
		'im gonna say the expunged words in the next message',//16
		'',//17
		'PHONEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO',//18
		'tad.degnupxE'//19
		];
	public static var STRUM_X = 42;
	public static var STRUM_X_MIDDLESCROLL = -278;
	public static var deGlelTexting:String = BPText[FlxG.random.int(0, 19)];
	...
	override public function create()
	{
		...
		var engineNameII:String = 'stupid';
		var randomThingyII:Int = FlxG.random.int(0, 4);
		switch(randomThingy)
	    {
			case 0:
				engineName = 'Dave ';
		...
		var WatermarkText = engineName + "Engine (PE v" + MainMenuState.psychEngineVersion + ")";
		switch(randomThingyII)
	    {
			case 0:
				engineNameII = 'Boyfren ';
			case 1:
				engineNameII = 'boyf ';
			case 2:
				engineNameII = 'boifend ';
			case 3:
				engineNameII = 'boyfried ';
			case 4:
				engineNameII = 'Davie ';
		}
		var creditsText:Bool = credits != '';
		var textYPos:Float = healthBarBG.y + 50;
		if (creditsText && ClientPrefs.hideMark == false )
		{
		...
		switch (SONG.song.toLowerCase())
		{
			default:
						...
						credits = 'DNB: Buttered Up v' + MainMenuState.ButteredVer 
						+ "\n" + engineNameII + "Engine v1.0";
					
		}
		
		
		
		// Add Kade Engine watermark (copied straight from dnb 2.5 sorri lol)
		watermarkes = new FlxText(4, textYPos, 0, "Psych Engine v" + MainMenuState.psychEngineVersion, 16);
		watermarkes.setFormat(Paths.font("comic.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		watermarkes.scrollFactor.set();
		watermarkes.borderSize = 1.25;
		add(watermarkes);
		watermarkes.cameras = [camHUD];

		var songMark = new FlxText(0, 10, 0, "// " + SONG.song + " [" + CoolUtil.difficultyString() + "] //", 20);
		songMark.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		songMark.scrollFactor.set();
		songMark.borderSize = 1.25;
		add(songMark);
		songMark.cameras = [camHUD];
		songMark.screenCenter(X);


		if ( ClientPrefs.hideMark == false ) 
			{
				watermarkes.text = WatermarkText;
			}
		if (creditsText && ClientPrefs.hideMark == false )
		{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, deGlelTexting, 32);
	...
	/*function popupWindow() // HI CHEATER :)
		{
			...
			window = Application.current.createWindow({
				title: "Dave x Bambi Shipping Cute HARD - Golden Apple v1 (KE 1.2)",
				width: 800,
				height: 800,
				borderless: true,
				alwaysOnTop: true
			...
			Application.current.window.onClose.add(function()
			{
				...
				if (window != null)
				{
					trace("EXPUNGED.DAT SUCCESSFULLY CONTAINED")
					window.close();
				}
			}, false, 100);
		...
		function generateWindowSprite()
			...
			}*/ // MIND YOU, LOOKING AT THE SOURCE CODE :) SHUT THE FUCK UP, YOU KNOW YOU'RE CHEATING. - EXPUNGED.DAT
